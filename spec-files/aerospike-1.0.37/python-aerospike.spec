%define name aerospike
%define version 1.0.37
%define unmangled_version 1.0.37
%define unmangled_version 1.0.37
%define release 1
...
BuildRoot: %{_tmppath}/aerospike-%{version}-%{release}-buildroot
Prefix: %{_prefix}
Vendor: Aerospike, Inc. <info@aerospike.com>
...
%prep
%setup -n aerospike-%{unmangled_version}
