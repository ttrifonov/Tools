...
Summary: Microsoft Azure client APIs
Name: python-azure
Version: %{version}
Release: %{release}%{?dist}
Source0: azure-%{unmangled_version}.tar.gz
License: Apache License 2.0
Group: Development/Libraries
BuildRoot: %{_tmppath}/azure-%{version}-%{release}-buildroot
Prefix: %{_prefix}
BuildArch: noarch
...
%prep
%setup -n azure-%{unmangled_version}
